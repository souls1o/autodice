...
# Public JSON-RPC defaults — override in .env if you run your own nodes
...
# Esplora-compatible Litecoin indexer (self-host electrs/esplora or use public)
LTC_RPC_URL = os.getenv("LTC_RPC_URL", "https://litecoinspace.org/api")
...
> 🤖 **Make a Ticket - I'M AUTOMATED (__$5-$300__)** <:ltc:1259292428175806504>
""",
...
-# @mention
-# !setplayer <@user|user_id> to set a new player
""",
        "mapping": {
...
""",
        "mapping": {
            "7s": ["1", "7s"],
            "7s_ties": ["2", "7s ties"],
            "plus1": ["3", "+1 on rolls", "plus1"],
            "lead": ["4", "lead", "l", "1-0 lead"],
            "ties": ["5", "ties", "t"],
            "fair": ["6", "fair", "f"],
        },
        "only_for": ["dice"],
